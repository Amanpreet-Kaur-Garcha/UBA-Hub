...
Public Class UBA_Hub_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UBA_HUB_PROJECT.UBA-Hub_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUBA_Hub_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UBA_Hub_Report = New UBA_Hub_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
